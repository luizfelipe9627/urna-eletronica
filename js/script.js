    ...
    if(candidato.length > 0) {
        ...
        for(let i in candidato.fotos) {
            if(candidato.fotos[i].small) {
                fotosHtml += `<div class="divisao1-image small"><img src="https://luizfelipe9627.github.io/urna-eletronica/assets/images/${candidato.fotos[i].url}" alt="" />${candidato.fotos[i].legenda}</div>`;
            } else {
                fotosHtml += `<div class="divisao1-image"><img src="https://luizfelipe9627.github.io/urna-eletronica/assets/images/${candidato.fotos[i].url}" alt="" />${candidato.fotos[i].legenda}</div>`;
            }
        }
